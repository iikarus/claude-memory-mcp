    ...
    if menu == "Explorer":
        ...
        if st.button("Refresh Graph"):
            ...
            for row in res.result_set:
                ...
                net.add_node(n.properties['id'], label=n.properties.get('name', 'Unknown'), title=str(n.properties))
                net.add_node(m.properties['id'], label=m.properties.get('name', 'Unknown'), title=str(m.properties))
